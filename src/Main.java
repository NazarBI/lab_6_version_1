...
public class Main {
    public static void main(String[] args) {
        ...
        Person person2 = new Person("Джон Доу", 30);

        person1.talk();
        person2.talk();

        Phone phone1 = new Phone("123-456-789", "Samsung Galaxy S21", 170.0);
        Phone phone2 = new Phone("987-654-321", "iPhone 12 Pro Max");

        phone1.receiveCall("Аліси");
        phone2.receiveCall("Боб", "456-789-012");

        phone1.sendMessage("123-456-789", "987-654-321");

        Car sedan = new Sedan("Toyota Camry", "Чорний", 250);
        Car truck = new Truck("Ford F-150", "Білий", 180, 2000);
